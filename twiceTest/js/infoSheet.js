...
"<ul class=\"form-section page-section\">"+
    ...
    "		   <h1 id=\"header_1\" class=\"form-header\" data-component=\"header\">混合测验<\/h1>"+
    "	  <\/div>"+
    "<\/div>"+
    ...
    "    <p class=\"MsoNormal\" style=\"font-family:Inter, sans-serif;\">本项目包含网页小游戏和情景事件归因测验，单次用时大约30分钟。具体分为以下流程：<\/p>"+    
    "    <p class=\"MsoNormal\" style=\"font-family:Inter, sans-serif; margin-bottom: 2px\">1. 第一次完成测验；<\/p>"+
    "    <p class=\"MsoNormal\" style=\"font-family:Inter, sans-serif; margin-top: 0.1rem;\">2. 服药后或晚上睡觉后的第二天早晨再次完成测验。<\/p>"+
    ...
    "     <hr width=\"300\" \/>"+
    "     <p style=\"margin-left:0.3rem; margin-bottom: 0.2rem;\">您是第几次做这个测验？<\/p>"+
    ...
    "         <p style=\"margin-top: 0.1em; font-size: 1.3em; display:flex; justify-content:center; color: #474b50; margin:auto;\">（点击+添加药品）<\/p>"+
    "      <\/fieldset>"+
    "   <\/div>"+
    "      <div id=\"medField\"><\/div>"+
    "      <hr width=\"300\" \/>"+
  ...
  if ($("input[name='playTime']:checked").val()=="first"){
    ...
    if ($("input[name='mentalIllness']:checked").val()=="no"){
      ...
      for (i=0; i<type.length; i++){
        ...
        medInfo.push({'otherMed': other[i].value});
      }
      var subInfo = {'run': $("input[name='playTime']:checked").val(),
