...
export default class SetGoalPanel {
    ...
    var mainTxt =  '请设定在接下来一轮的游戏中，你想要\n'+
                   '收集的金币总数。\n\n'+
                   '本轮游戏中，如果你 [color=#FFD700]每次都选择金币数\n'+
                   '量最多的那条路径[/color]，你将最终可以收集\n'+
                   '[color=#FFD700]'+maxRewBlock+' 金币[/color]（本轮可获得的最大金币总数）\n\n'+
                   ' 请拖动下方滑动条设定目标金币，\n'+
                   ' 点击 [b]确认[/b] 按钮开始游戏。\n';
...
var createDialog = function (scene, mainTxt, buttonTxt) {
    ...
    title: scene.rexUI.add.label({
        background: scene.rexUI.add.roundRectangle(0, 0, 80, 40, 20, 0xf57f17),
...
var createNumberBar = function (scene, maxRewBlock) {
    var numberBar = scene.rexUI.add.numberBar({ 
        ...
        text: scene.rexUI.add.BBCodeText(0, 0, '', {
            fontSize: '230%', fixedWidth: 50, fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont, "Microsoft YaHei", "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif',
