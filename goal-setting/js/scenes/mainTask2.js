...
export default class MainTask2 extends Phaser.Scene {
    ...
    create() {
        ...
        if (taskType == "planning") {
            ...
            .setOrigin(0,0) 
            .setScrollFactor(0); 
            progressText = this.add.text(decisionPointX+16, 18, prTxt, {color: "#000000",fontSize:'210%',fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont, "Microsoft YaHei", "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif',})
            .setAlign('center')
            .setScrollFactor(0);
...
var collectCoins2 = function(player, coin){
    ...
    if (taskType == "planning") {
        ...
        goalProgressBar.setDisplaySize(Math.round(goalProgress*(barWidth-6)), barHeight);
    }
};