...
var learning_trial = {
    ...
    prompt: null,  
    stimulus: function () {
        var stim = "<p style='font-weight: bold;'>"+jsPsych.timelineVariable('stimulus')+"</p>"+
...
var feedback = {
    ...
    stimulus: function () {
        ...
        if ( prev_data.timedout == false & prev_data.correct == 1 ) {
            stim_fb = "<p style='font-weight: bold;'>"+jsPsych.timelineVariable('stimulus')+"</p>"+
            ...
            stim_fb = "<p style='font-weight: bold; color: red;'><br>你没有及时做出选择！<br></p>"
        }
        return stim_fb;
    },
...
var task_intro = {
    ...
    is_html: true,
    stimulus: function () {
        var stim_br = ("<p><h2>事件场景学习</h2></p>"+
                    "<br>"+
                    "<p>"+
                    "<b>现在，你将准备开始学习第一个事件场景</b>。"+
                    "</p><br>"+
                    "<p>"+
                    "记住，每个场景都可以被认为代表 <i>一个人处于不同的情绪。"+
                    "</i>"+
                    "</p><br>"+
                    "<p>"+
                    "当你准备好开始的时候，请按下方的按钮！</b>"+
                    "</p>"+
                    "<br><br>"+
                    "</p>")
        return stim_br;
...
var freeTextFeedback = {
    ...
    [
      {
        type: 'text',
        prompt: `请总结上一个场景中负面事件正确原因的相似之处。一个短语或一个句子即可！`, 
        name: 'answer_neg', 
        textbox_rows: 2,
        textbox_columns: 60,
        required: true
...
var causeRatingNeg = {
    ...
    stimulus: function () {
        ...
        if ( blockNo == 0 ) {
            stim_text = `<h2> 小问题 </h2>
            <p>在开始测验之前，我们希望你 <b>回想一下过去几周发生在你身上的消极事件</b>。
            例如，工作或学习不顺利等等。</p>
            <p>请从以下几个维度来描述这次事件背后的原因。</p>
            <p>请拖动下方滑块做出你的选择，然后点击“继续”按钮。
            请注意，你必须移动所有滑块才能选择你的答案。</p>
            <p><b>引起消极事件的原因是...</b></p><br>`; 
        } else {
            stim_text = `<p><b>还是回想之前发生的消极事件，你会如何描述该事件背后的原因？</b></p>
            <p>请拖动下方滑块做出你的选择，然后点击“继续”按钮。
            请注意，你必须移动所有滑块才能选择你的答案。</p>
            <p><b>引起消极事件的原因是...</b></p><br>`; 
        }
    ...
    labels: [ ["<p class=\"reason\">完全由其他人或环境造成</p>", 
               '<p class=\"reason\">完全是我自身的原因</p>'],
              ['<p class=\"reason\">与当时特定情况有关</p>', 
               '<p class=\"reason\">每次似乎都是相同的原因</p>']
    ],
    button_label: '提交回答',
...
var causeRatingPos = {
    ...
    stimulus: function () {
        ...
        if ( blockNo == 0 ) {
            stim_text = `<h2> 小问题 </h2>
            <p>接下来，我们希望你 <b>回想一下过去几周发生在你身上的积极事情</b>。例如，在工作、社交或参加业余活动时表现良好的事情。</p>
            <p>请从以下几个维度来描述这次事件背后的原因。</p>
            <p>请拖动下方滑块做出你的选择，然后点击“继续”按钮。
            请注意，你必须移动所有滑块才能选择你的答案。</p>
            <p><b>引起积极事件的原因是...</b></p><br>`; 
        } else {
            stim_text = `<p><b>还是回想之前发生的积极事件，你会如何描述该事件背后的原因？</b></p>
            <p>请拖动下方滑块做出你的选择，然后点击“继续”按钮。
            请注意，你必须移动所有滑块才能选择你的答案。</p>
            <p><b>引起积极事件的原因是...</b></p><br>`; 
        }
    ...
    stimulus: function () {
        ...
        if ( blockNo < nBlocksLearning) {
            stim_br = ( "<br><br>"+
                        ...
                        "<br>"+
                        "<p>"+
                        "<b>你现在已经完成了当前事件场景学习</b>！"+
                        "</p>"+
                        "<p>"+
                        "当你准备好的时候，请 <b>点击继续按钮进入下一环节</b>。"+
                        "</p>"+
                        "<p>"+
                        "请注意，每个场景代表一个人处于不同的情绪。"+
                        "</p>"+
                        "<p>"+
                        "在新的场景中，事件背后的原因可能与前一场景中被认为是正确的原因不同。"+
                        "</p>"+
                        "<br><br>"+
                        "</p>")
        } else {
